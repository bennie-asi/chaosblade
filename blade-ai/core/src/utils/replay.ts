 ...
 *
 * 2026-08-21 (web-ui-v2-trace-layout): the web replay page is retired
 * — this module now has NO web-UI consumer. It stays because the
 * chat surface's ``/replay`` slash command (core/state/commands.ts)
 * still drives it; whether the command itself remains justified is
 * deferred to a later change's evaluation.
 *
