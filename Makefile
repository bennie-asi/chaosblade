...
ifneq ($(words $(BLADE_OPERATOR_PROJECT)),1)
$(error BLADE_OPERATOR_PROJECT must not contain spaces)
endif
ifneq ($(words $(BLADE_EXEC_JVM_PROJECT)),1)
$(error BLADE_EXEC_JVM_PROJECT must not contain spaces)
endif
